...
static List<Drink> Get() {
  ...
  return List.of([
    Drink("passionfruit-martini", "Passionfruit Martini", "test", "assets/images/real-drink-1.jpg", mockIngreds),
    Drink("old-fashioned", "Old Fashioned", "test", "assets/images/real-drink-2.jpg", mockIngreds),
    Drink("g&t", "Gin & Tonic", "test", "assets/images/real-drink-6.jpg", mockIngreds),
    Drink("whiskey-sour","Whiskey Sour", "test", "assets/images/real-drink-3.jpg", mockIngreds),
    ...
    for (var entry in yml.entries) {
      ...
      for (var e in nested[0]) {
        List<Ingredient> ingredients = Ingredient.yaml(
            e.value["ingredients"]);
        var drink = Drink(e.value["id"], e.value["name"], e.value["description"],
